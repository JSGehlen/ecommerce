# Generated by Django 3.0.5 on 2020-05-19 10:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('available_roasts', models.ManyToManyField(to='cart.RoastVariation')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('roast', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cart.RoastVariation')),
